...
public class FramewebPackageImpl extends EPackageImpl implements FramewebPackage {
	 ...
	 * @generated
	 */
	public EReference getVocabularyClass_Vocabularyproperty() {
		return (EReference)vocabularyClassEClass.getEStructuralFeatures().get(0);
	}
	...
	public void createPackageContents() {
		...
		createEReference(vocabularyClassEClass, VOCABULARY_CLASS__VOCABULARYPROPERTY);
	...
	public void initializePackageContents() {
		...
		initEReference(getVocabularyClass_Vocabularyproperty(), this.getVocabularyProperty(), null, "vocabularyproperty", null, 0, -1, VocabularyClass.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
